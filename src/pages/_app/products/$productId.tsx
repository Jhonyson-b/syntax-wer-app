...
function RouteComponent() {
  ...
  return <section className="container mb-10 pt-40 md:pt-60 pb-10 md:px-10">
      ...
      <div className="text-black">
        ...
        <div className="mb-6">
          ...
          <form className="flex gap-3">
            <input className="border border-[#c0c0c0] rounded-md p-3" type='text' placeholder='Insira seu CEP' />
